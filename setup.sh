...
curl -o /usr/local/bin/update-config.sh https://raw.githubusercontent.com/fdevadmin/hetzner-cloud-init/master/update-config.sh
...
ufw allow from 10.1.0.0/16 # default private network cidr
